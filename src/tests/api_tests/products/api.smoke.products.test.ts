...
import { getNewProduct, newProduct, productData } from '../../../data/products/product.data';
...
describe('Smoke api test', () => {
  ...
  context('Tests with valid data', () => {
    it('Should create product', async () => {
      const response = await ApiProductsActions.createProduct(token, productToCreate);
